...
fun RepoResponse.userDetail() : UserDetail {
    return UserDetail(owner.avatarURL, owner.login, owner.htmlURL)
}

fun RepoResponse.repoDetail() : RepoDetail {
    return RepoDetail(name, language, createdAt, updatedAt, htmlURL)
}